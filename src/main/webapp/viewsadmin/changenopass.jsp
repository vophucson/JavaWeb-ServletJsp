	...
	<nav class="hk-breadcrumb" aria-label="breadcrumb">
		<ol class="breadcrumb breadcrumb-light bg-transparent">
			...
			<li class="breadcrumb-item" aria-current="page"><a
				href="admin-postcarnopass?index=1">Danh sách bài đăng chưa duyệt</a></li>
			<li class="breadcrumb-item active" aria-current="page">Duyệt bài
				đăng</li>
		</ol>
		<!-- /Breadcrumb -->
	</nav>
		...
		<div class="hk-pg-header">
			<h4 class="hk-pg-title">
				<span class="pg-title-icon"><span class="feather-icon"><i
						data-feather="align-left"></i></span></span>Chỉnh sửa tình trạng bài đăng
			</h4>
		</div>
		<!-- /Title -->
			...
			<div class="col-xl-10">
				<section class="hk-sec-wrapper">
					...
					<div class="row">
						...
						<div class="col-sm">
							<form action="admin-changepost" method="POST">
