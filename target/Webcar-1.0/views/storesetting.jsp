			...
			<div class="col-md-6 col-sm-8">
				<div class="profile_wrap">
					...
					<c:if test="${dInfo != null}">
						<p class="text-danger text-center">Bạn đã có cửa hàng vui lòng
							nhập thông tin muốn thay đổi</p>
					</c:if>
					<c:if test="${dInfo == null}">
						<p class="text-danger text-center">Bạn chưa có cửa hàng vui
					...
					<form action="store-setting" method="POST"
						...
						<div class="form-group">
							<label class="control-label">Tên của hàng</label> <input
						...
						<div class="form-group">
							<label class="control-label">Giới thiệu cửa hàng</label>
